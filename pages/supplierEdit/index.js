...
Page({
  ...
  async init() {
    ...
    this.setData({
      classname: data.materials_class_name,
      materials_class_id: data.materials_class_id,
      companyname: data.companyname,
      cardpicurl: data.cardpicurl,
      contact: data.contact_data,
      address: data.address,
      alias_name: data.alias_name,
      bank,
      remarks: data.remarks,
      tempFilePaths: data.orcurl,
    });
  },
  go_second_step() {
    if (
  ...
  async affirm() {
    ...
    data["contact_data"] = this.data.contact;
    data["address"] = this.data.address;
    data["alias_name"] = this.data.alias_name;
    data["bank_data"] = this.data.bank;
